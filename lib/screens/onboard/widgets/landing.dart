            ...
            children: [
              ...
              Row(
                ...
                children: [
                  ...
                  const Expanded(
                    child: Text("Keeps Privacy Protected. No data shared."),
                  )
                ],
              ),
              const Expanded(child: SizedBox()),
              const Text("""
Since this application is currently in beta, be prepared for UI changes and unexpected behaviours. It's being updated regularly, so look out for new updates."""),
              const SizedBox(
                height: 20,
              ),
              Container(
